...
function email_form_submission($form) {
	...
	$mail-> SMTPSecure = 'tls';
	$mail-> Port = 587;
	$mail-> setFrom('eventos@casademontevideu.pt','Eventos - Casa de Montevideu');
	$mail-> addAddress('eventos@casademontevideu.pt','Cliente');
	$mail-> Subject = $subject;
	$mail-> isHTML(true);
	$mail-> Body = $message;


	if(!$mail->send())//aqui estava !$sent
